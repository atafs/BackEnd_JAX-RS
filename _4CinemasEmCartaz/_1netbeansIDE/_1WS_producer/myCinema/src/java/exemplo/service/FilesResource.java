...
public class FilesResource {
    ...
    public FilesResource() {
        ...
        String trailer2Desc = "Warcraft (no Brasil, Warcraft: O Primeiro Encontro de Dois Mundos[1] ) é um filme norte-americano de ação fantasia épico e de aventura, dirigido por Duncan Jones e escrito por Jones e Charles Leavitt e é distribuído mundialmente pela Universal Pictures, assim tendo seus efeitos visuais produzidos pela Industrial Light & Magic. O filme foi anunciado pela primeira vez em 2006 com a parceria do projeto com a Legendary Pictures[2] . O filme é baseado na série de jogos homônimos que foi produzido pela Blizzard Entertainment.\n";
        trailer2Desc += "O enredo consiste na história da origem dos encontros iniciais entre os seres humanos e os orcs , com ênfase em cima tanto a Aliança de ambos os lados da Horda de seu conflito. Características que caracterizam tais como Durotan e Lothar, o filme terá lugar em uma variedade de locais estabelecidos na série de videogames.\n";
        trailer2Desc += "O elenco é composto por Ben Foster, Travis Fimmel, Paula Patton, Dominic Cooper, Toby Kebbell, Rob Kazinsky, Daniel Wu, Clancy Brown, Ben Schnetzer, Ruth Negga, Burkely Duffield, Daniel Cudmore e Callum Keith Rennie.\n";
        trailer2Desc += "O filme esta previsto para ser lançado no dia 10 de junho de 2016.";
    ...
    /**
     * Retrieves representation of an instance of exemplo.servicos.FilesResource
